...
//CHECKSTYLE:OFF
/**
 * An implementation of <code>Graph</code> that is suitable for sparse graphs and permits both directed and undirected
 * edges.
 */
@SuppressWarnings("all")
public class SparseGraph<V extends RelationalNode, E> extends AbstractGraph<V, E> implements Graph<V, E> {
    /**
     ...
     */
    public static <V extends RelationalNode, E> Factory<Graph<V, E>> getFactory() {
    ...
    protected Map<V, Map<V, E>[]> vertex_maps; // Map of vertices to adjacency maps of vertices to {incoming, outgoing,
                                               // incident} edges
