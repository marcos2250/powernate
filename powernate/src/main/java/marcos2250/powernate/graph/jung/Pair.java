...
/**
 * An implementation of <code>Collection</code> that stores exactly 2 non-null objects and is not mutable. They respect
 * <code>equals</code> and may be used as indices or map keys.
 * <p>
 * Note that they do not protect from malevolent behavior: if one or another object in the tuple is mutable, then it
 * can be changed with the usual bad effects.
 */
// CHECKSTYLE:OFF
...
public class Pair<T> implements Collection<T>, Serializable {
     ...
     * @throws IllegalArgumentException if the input collection is null, contains null values, or has != 2 elements.
     */
     ...
     * 
     * @throws IllegalArgumentException if the input array is null, contains null values, or has != 2 elements.
     */
